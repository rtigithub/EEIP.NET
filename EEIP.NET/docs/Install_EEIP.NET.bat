...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "EEIP.NET" /productName "EEIP.NET" > NUL
...
COPY /Y "EEIP.NET.msha" HelpContentSetup.msha
